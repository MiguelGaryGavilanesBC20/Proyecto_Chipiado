...
public class Panel_Jugador extends JPanel implements ActionListener {
    ...
    public Panel_Jugador(DefaultTableModel modeloTabla1) {
        ...
        modeloTabla1.addColumn("Fecha de Nacimiento");
        modeloTabla1.addColumn("Equipo");

        tabla = new JTable(modeloTabla1);
        ...
        if (e.getSource() == boton2) {
            ...
            if (nombre.isEmpty() || apellido.isEmpty() || fechaNacimiento.isEmpty() || equipo.isEmpty()) {
                ...
                if (validarFecha(fechaNacimiento)) {
                    ...
                    modeloTabla1.addRow(new Object[]{nombre, apellido, fechaNacimiento, equipo});
                    texto1.setText("");
                    texto2.setText("");
                    texto3.setText("");
                } else {
